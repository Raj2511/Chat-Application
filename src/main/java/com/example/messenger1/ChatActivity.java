...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 438 && requestCode == RESULT_OK && data!=null && data.getData()!=null)
        {
            ...
            if (!checker.equals("image"))
            {
                ...
                DatabaseReference userMssageKeyRef = RootRef.child("Messages").child(messageSenderID)
                        .child(messageReceiverID).push();
                final String messagePushID = userMssageKeyRef.getKey();
    ...
    private void SendMessage()
    {
        ...
        else
        {
            ...
            DatabaseReference userMssageKeyRef = RootRef.child("Messages").child(messageSenderID)
                    .child(messageReceiverID).push();
            String messagePushID = userMssageKeyRef.getKey();
