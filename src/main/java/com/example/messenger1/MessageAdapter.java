    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, final int position)
    {
        ...
        else if (fromMessageType.equals("pdf") || fromMessageType.equals("docx"))
        {
            if (fromUserID.equals(messageSenderId))
            {
                ...
                Picasso.get()
                        .load("https://firebasestorage.googleapis.com/v0/b/my-application-1a744.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=4b1bfb65-3885-48e5-9daf-7e38fb670364")
                        .into(messageViewHolder.messageSenderPic);
            ...
            else
            {
                ...
                Picasso.get()
                        .load("https://firebasestorage.googleapis.com/v0/b/my-application-1a744.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=4b1bfb65-3885-48e5-9daf-7e38fb670364")
                        .into(messageViewHolder.messagereceiverPic);
